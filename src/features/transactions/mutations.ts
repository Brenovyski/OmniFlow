  ...
  return useMutation({
    ...
    onMutate: async (input) => {
      ...
      const optimistic: Transaction = {
        ...
        pluggy_status: null,
        pluggy_category: null,
        pluggy_description_raw: null,
        pluggy_provider_code: null,
        pluggy_balance_after_cents: null,
        pluggy_merchant_name: null,
        pluggy_merchant_category: null,
        pluggy_cc_installment: null,
        pluggy_cc_total_installments: null,
        pluggy_cc_bill_id: null,
        pluggy_deleted_at: null,
        user_edited_fields: [],
        holding_id: null,
      };
