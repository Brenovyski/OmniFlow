...
- **Migrations 001 + 002 + 003 + 004 + 005 + 006 applied** to the hosted project via `pnpm dlx supabase db push`. Project is linked; future migrations are pushed by Claude automatically as soon as the SQL file lands (see *Database migrations* above). Migration numbering for steps 8/13/14 shifted again: holdings is now 007, recurring is 008, budgets is 009.

Next step (step 8) is **Migration 007 + Investments page + holdings**. See `implementation_plan.md` step 8.
...
- [ ] **Step 8** — Migration 007 + Investments page + holdings
